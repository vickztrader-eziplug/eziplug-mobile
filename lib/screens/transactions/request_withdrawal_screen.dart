    ...
    return Container(
      ...
      child: widget.payoutAccounts.isEmpty
          ? Padding(
              ...
              child: Column(
                children: [
                  Icon(Icons.account_balance_outlined, size: 48, color: isDark ? Colors.white24 : Colors.grey.shade400),
                  const SizedBox(height: 12),
                  Text(
                    'No payout accounts found',
                    style: TextStyle(color: isDark ? Colors.white24 : Colors.grey.shade600),
                  ),
                ],
              ),
            )
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(
                            ...
                            color: isSelected ? primaryColor : (isDark ? Colors.white38 : Colors.grey.shade600),
                            size: 24,
                          ),
                        ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isSelected ? primaryColor : (isDark ? Colors.white24 : Colors.grey.shade400),
                              width: 2,
                            ),
        ...
        children: _amounts.map((amount) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected ? primaryColor : (isDark ? Colors.white.withOpacity(0.05) : Colors.grey.shade100),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: isSelected ? primaryColor : (isDark ? Colors.white.withOpacity(0.1) : Colors.grey.shade300),
                  width: 1,
                ),
              ),
              child: Text(
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: isValid ? primaryColor : (isDark ? Colors.white10 : Colors.grey.shade400),
