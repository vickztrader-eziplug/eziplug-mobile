    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: theme.textTheme.titleLarge?.color ?? (theme.brightness == Brightness.dark ? Colors.white : Colors.black87),
          letterSpacing: 0.5,
        ),
      ),
    );
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              // Theme context for the content section
              Builder(
                builder: (context) {
                  final theme = Theme.of(context);
                  final isDark = theme.brightness == Brightness.dark;
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Funding Section
                              _sectionTitle(context, "Fund Your Wallet"),
                              _buildFundingOption(
                                context: context,
                              ...
                              // Withdrawal Section
                              _sectionTitle(context, "Withdraw Funds"),
                              _buildFundingOption(
                                context: context,
