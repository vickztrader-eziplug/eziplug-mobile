...
class _ElectricityScreenState extends State<ElectricityScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseBody['results'] != null) {
          ...
          // Check if results has a 'data' key or is the array itself
        ...
        if (mounted && billsData is List) {
          setState(() {
            // Extract electricity providers from bills
            _providers = billsData['data']
                .where(
                  (bill) =>
    ...
    if (mounted) {
      setState(() {
        _providers = [
          ...
          {'id': 8, 'serviceID': 'jos-electric', 'name': 'JED - Jos Electric'},
          {
            'id': 9,
          ...
          {'id': 11, 'serviceID': 'aba-electric', 'name': 'ABA - Aba Power'},
          {
            'id': 12,
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'serviceID':
              _selectedProviderServiceId, // Use serviceID for validation
  ...
  Future<void> _purchaseElectricity(String pin) async {
    ...
    try {
      ...
      final payload = {
        'serviceId': _selectedProviderId
            .toString(), // Use numeric ID for bill purchase
        'billersCode': _meterController.text,
                            ...
                            _isFetchingProviders
                                ...
                                : _buildDropdown(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      setState(() {
                                        // Store BOTH the numeric id and string serviceID
