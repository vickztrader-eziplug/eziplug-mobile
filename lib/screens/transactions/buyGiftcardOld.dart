...
class _BuyGiftCardScreenState extends State<BuyGiftCardScreen> {
  ...
  final List<String> _categories = ['Physical', 'E-code'];

  final List<String> _creditUnits = [
    '\$10',
    '\$25',
    '\$50',
    '\$100',
  ...
  Future<void> _proceedToPin() async {
    ...
    if (_selectedCreditUnit == null) {
      _showSnackBar('Please select a credit unit', Colors.red);
      return;
    }
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => PinEntryScreen(
          ...
          subtitle: 'Enter your 4 digit PIN to buy gift card',
          onPinComplete: (pin) => _buyGiftCard(pin),
          onForgotPin: () {
  ...
  Future<void> _buyGiftCard(String pin) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(Constants.buyGiftCardUrl),
        headers: {
        ...
        body: jsonEncode({
          ...
          'card_type': _selectedGiftCard,
          'category': _selectedCategory,
          'credit_unit': _selectedCreditUnit,
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => ReceiptScreen(
              ...
              subtitle: 'Your gift card has been purchased successfully',
              details: [
                ReceiptDetail(
        ...
        Navigator.pop(context);
        _showSnackBar(
          responseData['message'] ?? 'Failed to buy gift card',
          Colors.red,
        );
      }
    } catch (e) {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildLabel('Credit Unit'),
                      const SizedBox(height: 8),
                      _buildDropdown(
                        hint: 'Select credit unit',
                        value: _selectedCreditUnit,
                        items: _creditUnits,
                        onChanged: (value) {
                          setState(() => _selectedCreditUnit = value);
                        },
                      ),
                      const SizedBox(height: 20),
                      ...
                      _buildTextField(
                        ...
                        hintText: 'Enter gift card quantity',
